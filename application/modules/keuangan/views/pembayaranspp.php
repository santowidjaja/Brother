...
<?php endforeach; ?>
      ...
      <div class="box-body">
        ...
        <!-- Posts List -->
        <form method="POST" action="<?= base_url('keuangan/bayarbiaya') ?>" enctype="multipart/form-data" class="form-inline">
    ...
    <td colspan='7' align='right'>";
              echo '<a href="#" onclick="chunchall(this);return false"class="btn btn-warning">Check all</a>&nbsp;with selected &nbsp; <input class="btn btn-primary" type="submit" onclick="return confirm(Anda yakin ? )" name="btn" value="Bayar"></td></tr></form>';

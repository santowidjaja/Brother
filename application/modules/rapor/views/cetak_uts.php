        ...
        <table id='example' class='table table-bordered table-striped'>
            ...
            foreach ($getlistsiswa as $dt) : ?>
              <tr><td><?= $sno++ ?></td>
                              ...
                              <td><a target='_blank' class='btn btn-primary btn-xs' href='<?= base_url('rapor/print_raport_uts/'.$tahunakademik_id.'/'.$kelas_id.'/'.$dt['id']); ?>'><i class="fa fa-sticky-note"></i> Raport UTS</a>
</td>

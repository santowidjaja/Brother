...
<tr>
		<td>Kode Mapel*</td>
		<td>:</td>
        <td><input type="text" name="kode_mapel" value="<?= $kodemapelauto; ?>"  
    ...
    <tr>
		<td>Nama Mapel*</td>
		<td>:</td>
        <td><input type="text" name="nama_mapel" value="<?= set_value('nama_mapel'); ?>"  
    ...
    <tr>
		<td>Singkatan</td>
		<td>:</td>
        <td><input type="text" name="sk_mapel" value="<?= set_value('sk_mapel'); ?>"  
...
<tr>
		<td>Tingkat*</td>
		<td>:</td>
        <td><input type="number" name="tingkat" value="<?= set_value('tingkat'); ?>"  class="form-control <?php echo form_error('tingkat') ? 'is-invalid' : '' ?>">
        <div class="invalid-feedback">
                            <?= form_error('tingkat') ?>
                        </div></td>
    </tr>
    <tr>
		<td>Urutan</td>
		<td>:</td>
        <td><input type="text" name="urutan" value="<?= set_value('urutan'); ?>"  class="form-control <?php echo form_error('urutan') ? 'is-invalid' : '' ?>">
        <div class="invalid-feedback">
                            <?= form_error('urutan') ?>
                        </div></td>
	</tr>
    <tr>
		...
		<td>
                        <select name="kelompok_id" id="kelompok_id" class="form-control <?= form_error('kelompok_id') ? 'is-invalid' : '' ?>">
                            ...
                            <option value="<?= $dt['id']; ?>"><?= $dt['nama_kelompok']; ?></option>
                            <?php endforeach; ?>
                        </select>
                        <div class="invalid-feedback">

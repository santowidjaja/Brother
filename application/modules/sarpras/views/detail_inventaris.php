      ...
      <?php $kode_inv= generatekodeinc('sar_inventaris','INV','kode_inv');?>
        <div class="row">
          <div class="col-md-4">
            ...
            <input class="form-control" type="hidden" name="barang_id" value="<?= $namabarang['id'] ?>" />
            ...
            <div class="form-group <?php echo form_error('kode_inv') ? 'has-error' : '' ?>">
              ...
              <a href="<?= base_url('sarpras/inventaris'); ?>" class="btn btn-default">Kembali</a>
            </form>
          </div>
          <div class="col-md-8">
                ...
                <tbody>
                  ...
                  <?php foreach ($get_inventaris_barang as $dt) : ?>
                    <tr>
                      ...
                      <td>
                      <a href="<?= base_url('sarpras/editinventaris/'.$dt['barang_id'].'/'. $dt['id']); ?>" class="btn btn-warning btn-xs">Edit</a>&nbsp;&nbsp;
                      <a href="<?= base_url('sarpras/hapusinventaris/'.$dt['barang_id'].'/'. $dt['id']); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Anda yakin ? data tidak dapat dikembalikan lagi...');">Delete</a>
                      </td>
                    </tr>
                    <?php $i++; ?>

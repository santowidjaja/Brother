            ...
            foreach ($jadwal_pelajaran as $dt) : ?>
              <tr>
                ...
                <?php if ($dt['guru_id']==$guru_id){?>
                  <a href="<?= base_url('guru/journalkbm_list/' . $dt['id']); ?>" class="btn btn-success btn-xs"><span class='glyphicon glyphicon-th-list'></span> Lihat Journal</a>&nbsp;&nbsp;
                  <a href="<?= base_url('guru/cetak_journalkbm/' . $dt['id']); ?>"target="new" class="btn btn-warning btn-xs"><span class='glyphicon glyphicon-print'></span>Cetak</a>
                  <?php } ?>
                </td>
              </tr>
            <?php endforeach; ?>

          ...
          <tbody>
            ...
            foreach ($jadwal_pelajaran as $dt) : ?>
              <tr>
                ...
                <td>
                <?php if ($dt['guru_pengajar']==$guru_id){?>
                  <a href="<?= base_url('guru/input_nilai_pengetahuan_edit/' . $dt['id']); ?>" class="btn btn-success btn-xs"><span class='glyphicon glyphicon-th-list'></span> Nilai Pengetahuan</a>
                  <a href="<?= base_url('guru/input_nilai_keterampilan_edit/' . $dt['id']); ?>" class="btn btn-primary btn-xs"><span class='glyphicon glyphicon-th-list'></span> Nilai Keterampilan</a>
                <?php } ?>
                </td>
              </tr>
            <?php endforeach; ?>

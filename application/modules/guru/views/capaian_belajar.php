...
<form method="post" action="<?= base_url('guru/capaian_belajar_add') ?>" >
        <table id='example' class='table table-bordered table-striped'>
            ...
            foreach ($getcapaianbelajar as $dt) : ?>
              <tr><td><?= $sno++ ?></td>
                              ...
                              <td><center><input type='text' name='a1[]' value='<?= $dt['spiritual_predikat'] ?>' style='width:70px; text-align:center; padding:0px; color:blue'></center></td>
                              <td><?= $dt['spiritual_deskripsi'] ?></td>
                              <td><center><input type='text' name='c1[]' value='<?= $dt['sosial_predikat'] ?>' style='width:70px; text-align:center; padding:0px; color:blue'></center></td>

...
<tr><td scope='row'>Tanggal</td>  <td><input type='text' style='border-radius:0px; padding-left:12px' class='datepicker form-control' value='<?= set_value('tanggal', isset($tanggalskrg) ?$tanggalskrg:'') ?>' id='tanggal' name='tanggal'>
<div class="invalid-feedback"><?= form_error('tanggal') ?></div>               
</td></tr>
<tr><td scope='row'>Jam Ke</td>  <td><input type='number' class='form-control' value='1' name='jamke'>
<div class="invalid-feedback"><?= form_error('jamke') ?></div> </td></tr>

<tr><td scope='row'>Materi</td>  <td><textarea style='height:80px' class='form-control' name='materi'><?= set_value('materi') ?></textarea>
<div class="invalid-feedback"><?= form_error('materi') ?></div>
</td></tr>

<tr><td scope='row'>Keterangan</td>  <td><textarea style='height:160px'  class='form-control' name='keterangan'></textarea></td></tr>
                    </td></tr>
                  </tbody>
                  </table>
              </div>
              ...
              <input class="form-control" type="hidden" name="guru_id" value="<?= $get_datajadwal['guru_id']; ?>">
                    ...
                    <a href='<?= base_url('guru/journalkbm_list/'.$jadwal_id)?>'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>

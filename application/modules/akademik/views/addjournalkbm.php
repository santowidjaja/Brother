              ...
              <table class='table table-condensed table-bordered'>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><input type='text' style='border-radius:0px; padding-left:12px' class='datepicker form-control' value='<?= set_value('tanggal', isset($tanggalskrg) ? $tanggalskrg : '') ?>' id='tanggal' name='tanggal'>
                      <div class="invalid-feedback"><?= form_error('tanggal') ?></div>
                    </td>
                  </tr>
                  <tr>
                    <td scope='row'>Jam Ke</td>
                    <td><input type='number' class='form-control' value='1' name='jamke'>
                  ...
                  <tr>
                    ...
                    <td><textarea style='height:80px' class='form-control' name='materi'><?= set_value('materi') ?></textarea>
                  ...
                  <tr>
                    ...
                    <td><textarea style='height:160px' class='form-control' name='keterangan'></textarea></td>
                  </tr>
                  </td>
                  </tr>
                </tbody>

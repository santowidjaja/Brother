              ...
              <table class='table table-condensed table-bordered'>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><input type='text' style='border-radius:0px; padding-left:12px' class='datepicker form-control' value='<?= $get_datajurnal['tanggal'] ?>' id='tanggal' name='tanggal'>
                      <div class="invalid-feedback"><?= form_error('tanggal') ?></div>
                    </td>
                  </tr>
                  <tr>
                    <td scope='row'>Jam Ke</td>
                    <td><input type='number' class='form-control' value='<?= $get_datajurnal['jamke'] ?>' name='jamke'>
                      <div class="invalid-feedback"><?= form_error('jamke') ?></div>
                    </td>
                  </tr>

                  <tr>
                    <td scope='row'>Materi</td>
                    <td><textarea style='height:80px' class='form-control' name='materi'><?= $get_datajurnal['materi'] ?></textarea>
                  ...
                  <tr>
                    ...
                    <td><textarea style='height:160px' class='form-control' name='keterangan'><?= $get_datajurnal['keterangan'] ?></textarea></td>
                  </tr>
                  </td>
                  </tr>
                </tbody>

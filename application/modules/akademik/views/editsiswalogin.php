    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <form method="post" action="<?php base_url('akademik/editsiswalogin') ?>" enctype="multipart/form-data" id="posts">
            ...
            <table class="table">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?= base_url('akademik/siswa_login') ?>"><span class="btn btn-warning">Batal</span></a>
                    </td>
                </tr>
            </table>
            </form>

...
<tr>
		<td>No Formulir</td>
		<td>:</td>
		<td><input type="text" name="noformulir"value="<?= set_value('noformulir', isset($getsiswa['noformulir']) ?$getsiswa['noformulir']:'') ?>"
		class="form-control <?php echo form_error('noformulir') ? 'is-invalid' : '' ?>">
		<div class="invalid-feedback">

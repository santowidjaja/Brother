...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="<?= base_url('authppdb/logout') ?>"><i class="fa fa-power-off text-red"></i> <span>Logout</span></a></li>
            <?php }else{?>
                <li><a href="<?= base_url('authsiswa/logout') ?>"><i class="fa fa-power-off text-red"></i> <span>Logout</span></a></li>
                              <?php  } ?>
        </ul>
    </section>
    <!-- /.sidebar -->
